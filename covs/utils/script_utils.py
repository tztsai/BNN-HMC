...
def get_prior(args):
  if args.prior_family.lower() == "gaussian":
    return losses.make_gaussian_log_prior(args.weight_decay, args.temperature)
  elif args.prior_family.lower() == "expfnormp":
    return losses.make_exp_fnorm_p_log_prior(
      args.weight_decay, args.expfnormp_power, args.temperature)
  elif args.prior_family.lower() == "laplace":
    return losses.make_laplace_log_prior(
...
def get_data_model_fns(args):
  ...
  log_prior_fn, log_prior_diff_fn = get_prior(args)
